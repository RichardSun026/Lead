...
import { User, Phone, MapPin, Hash, FileText, MessageSquare, Edit3, Save, X } from 'lucide-react';
...
const LeadReport = () => {
  ...
  const [leadData, setLeadData] = useState({
    ...
    zipcode: "90210",
    surveySummary: "Highly interested in premium package. Budget range: $50K-75K. Timeline: Q2 2024. Primary concerns: ROI and implementation timeline.",
    messageSummary: "Initial contact via website form. Expressed urgency for solution. Prefers email communication. Available for calls Tuesday-Thursday 2-4 PM EST."
  });
