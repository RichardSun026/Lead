...
export default function App() {
  ...
  const handleInfoSubmit = async (e) => {
    ...
    if (
      ...
      alert('O embed do vídeo deve conter um <iframe> com a origem player.vimeo.com');
      setIsLoading(false);
      return;
    }
          ...
          {step === 2 && (
            <form className="space-y-6" onSubmit={handleInfoSubmit}>
              <div className="text-center mb-8">
                ...
                <p className="text-white/70">Precisamos apenas de alguns detalhes</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <p className="text-xs text-white/60 mt-1">
                    Cole o código do iframe que começa com{' '}
                    <code>&lt;iframe src="https://player.vimeo.com"</code>
                  </p>
                  <p className="text-xs text-white/60 mt-1">
                    Se não conseguir seguir estas instruções, envie um email{' '}
                    <a
                    ...
                    e ajustaremos manualmente para você.
                  </p>
                </div>
              </div>
